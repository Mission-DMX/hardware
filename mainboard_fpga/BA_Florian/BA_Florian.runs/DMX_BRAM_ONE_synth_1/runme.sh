...
HD_PWD='/home/eisenbahn/Schreibtisch/AAA_Florian_BA/VIvado/Programme/BA/BA_Florian/BA_Florian.runs/DMX_BRAM_ONE_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMX_BRAM_ONE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMX_BRAM_ONE.tcl
