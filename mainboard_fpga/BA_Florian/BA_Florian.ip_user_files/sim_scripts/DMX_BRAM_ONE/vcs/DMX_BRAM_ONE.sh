...
design_libs=(xpm blk_mem_gen_v8_4_9 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_9 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.DMX_BRAM_ONE xil_defaultlib.glbl -o DMX_BRAM_ONE_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./DMX_BRAM_ONE_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/eisenbahn/Schreibtisch/AAA_Florian_BA/VIvado/Programme/BA/BA_Florian/BA_Florian.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key DMX_BRAM_ONE_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc DMX_BRAM_ONE_simv.daidir vcs_lib c.obj)
