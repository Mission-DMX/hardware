...
#
# Script generated by Vivado on Tue Apr 22 12:31:17 CEST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : DMX_BRAM_ONE.sh
...
#
# Usage        : DMX_BRAM_ONE.sh
#                DMX_BRAM_ONE.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DMX_BRAM_ONE.sh [-reset_run]
#                DMX_BRAM_ONE.sh [-reset_log]
#                DMX_BRAM_ONE.sh [-help]
#
...
#                script (type 'DMX_BRAM_ONE.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname blk_mem_gen_v8_4_9 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm blk_mem_gen_v8_4_9 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "DMX_BRAM_ONE.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DMX_BRAM_ONE.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work blk_mem_gen_v8_4_9 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.DMX_BRAM_ONE xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.DMX_BRAM_ONE -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/eisenbahn/Schreibtisch/AAA_Florian_BA/VIvado/Programme/BA/BA_Florian/BA_Florian.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log DMX_BRAM_ONE_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DMX_BRAM_ONE.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DMX_BRAM_ONE.sh [-help]\n\
Usage: DMX_BRAM_ONE.sh [-step]\n\
Usage: DMX_BRAM_ONE.sh [-lib_map_path]\n\
Usage: DMX_BRAM_ONE.sh [-reset_run]\n\
Usage: DMX_BRAM_ONE.sh [-reset_log]\n\
Usage: DMX_BRAM_ONE.sh [-keep_index]\n\
Usage: DMX_BRAM_ONE.sh [-noclean_files]\n\n\
